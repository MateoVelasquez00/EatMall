<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Admin.Master" AutoEventWireup="true" CodeBehind="Pedidos.aspx.cs" Inherits="EatMall.Vista.Usuario.GestionLocal.Pedidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <asp:GridView
        ...
        <Columns>
            ...
            <%# Eval("Estado").ToString() == "Pendiente" ? "badge-pendiente" :
                Eval("Estado").ToString() == "Preparando" ? "badge-preparando" :
                "badge-entregado" %>'>
                        <%# Eval("Estado") %>
                    </span>
                </ItemTemplate>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#gvPedidos tr:first').wrap('<thead></thead>');

            if ($.fn.dataTable.isDataTable('#gvPedidos')) {
                $('#gvPedidos').DataTable().destroy();
            }
