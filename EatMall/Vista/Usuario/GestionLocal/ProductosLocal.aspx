...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
	...
	<div class="cabecera-Producto">
		...
		<div class="d-flex align-items-center gap-2">
			<label style="font-weight: 600; color: #3d4a42;">Seleccionar Local:</label>
			<asp:DropDownList
				ID="ddlLocales"
				runat="server"
				AutoPostBack="true"
				CssClass="form-select"
				Style="border: 1px solid #bccac0; border-radius: 10px; padding: 6px 12px; min-width: 200px;"
	...
	<script>
		...
		}); <a href="MiLocal.aspx">MiLocal.aspx</a>
	</script>
